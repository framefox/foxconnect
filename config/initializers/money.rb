...
MoneyRails.configure do |config|
  ...
  # Set default bank to instance of RatesExchangeBank
  # config.default_bank = EuCentralBank.new

  # Add exchange rates service (optional)
  # config.rates_exchange_service = :eu_central_bank
  ...
  # Set rounding mode to avoid warnings
  config.rounding_mode = BigDecimal::ROUND_HALF_UP

  # Set locale backend to avoid deprecation warnings
  config.locale_backend = :currency
end
